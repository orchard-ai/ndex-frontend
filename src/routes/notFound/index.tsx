...
const PageNotFound = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-ndex-light-background-1 dark:bg-ndex-dark-background-default">
      <button
        className="mb-20 text-6xl w-40 h-20 rounded-lg font-light text-ndex-light-text-primary
      ...
      <button
        className="flex text-ndex-button-text-filled-light border-2 rounded-lg w-64 h-8 shadow-md bg-ndex-button-filled-light
