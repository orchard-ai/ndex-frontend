...
const DefaultCard = ({user, setModifying} : PropType) => {
  return (
    <div className="flex flex-col w-[80%] p-12 space-y-4 justify-center rounded-lg bg-ndex-background-2">
      ...
      <div className="space-y-4 font-bold">
        ...
        <div className="flex space-x-4">
          <button className="pt-2 pb-2 pr-4 pl-4 rounded-sm text-ndex-text-white border-ndex-button-bordered-grey bg-ndex-button-bordered-grey" onClick={() => setModifying(true)}>  Edit Profile </button>
