...
export default function Header({ className }: PropType) {
  ...
  return (
    <div
      className={`flex flex-row items-center justify-between ${className} my-5`}
    >
      {/* Empty Div to fix centering */}
      <Link
        to={ROUTES.SETTINGS_ACCOUNT}
        className="
        relative flex items-center justify-center rounded-lg w-20 h-10 ml-10 text-center z-10
